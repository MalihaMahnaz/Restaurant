        ...
        <motion.div 
          ...
          <div className='flex justify-between items-center px-4 lg:px-0 relative text-white'>
            ...
            <motion.div 
              ...
              className={`${nav? 'gap-y-0': 'gap-y-2'} flex flex-col items-center justify-center w-12 h-12 p-3 order-2 lg:order-none cursor-pointer border-2 rounded-full`} onClick={()=> setNav(!nav)}>
            ...
            <motion.div variants={fadeIn('down','tween',1.2,1.4)}
              ...
              <a href='#'>
                {/* if header is active, make logo 90x90 px, otherwise, 107x107 px */}
                <img className={`${isActive ? 'w-[90px] h-[90px]': 'w-[107px] h-[107px]'}`} src={LogoWhite}/>
              </a>
            </motion.div>
            {/* social icons */}
            <motion.div 
